...
double func1Deriv(double x){
    ...
    double y = -2.9 * sin(x + 2.5) * sin(0.39 * (1.5 + x)) + 1.131 * cos(x + 2.5) *\
 cos(0.39 * (1.5 + x)) + 0.76 * sin(thr * x) * sin(two * x)\
 + 0.438462 * x * cos(thr * x) * tan (two * x) + 0.161702 * x * sin(thr * x) * pow((1/cos(two * x)), 2);
    return y;
}
