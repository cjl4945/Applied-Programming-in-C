 ...
 *          R. Repka  12/24/2017 -use strncpy()
 * *****************************************************************************/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
//char *RemoveFromBackOfLinkedList(LinkedLists *ListPtr);
      ...
      if (NULL != DataFile)
        {
         ...
         {
            fprintf(stdout, "Found %s at index %d in the Dynamic Array \n",
                TempDArrayData->String, TempDArrayData->Num);
         }
