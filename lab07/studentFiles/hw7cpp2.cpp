...
#include <iostream>
#include "Timers.h"         
// add IO and calculation repeat macros here
   ...
   if (1 != argc)
     ...
     // Insert your data timer start loops here
      ...
      do {
         ...
         // move this under the while loop just before the end of your timing loop
#ifdef MOVE_IO_CLOSE                        
         InputFile.close();
         InputFile.clear();
#endif 
